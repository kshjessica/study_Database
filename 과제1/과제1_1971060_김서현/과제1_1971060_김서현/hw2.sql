...
INSERT INTO Drivers (name, birthday, country, constructor) VALUES
     ...
     ('vettel', '1987-07-03', 'German'),
     ('barrichello', '1972-05-23', 'Brazilian'),
     ('Irvine', '1965-11-10', 'British'),
     ('Schmacher', '1969-01-03', 'German');

SELECT * FROM Drivers;

INSERT INTO Races (name, beginDate, area) VALUES
...
INSERT INTO Results (race, driver, race_rank) VALUES
     ...
     ('Spanish Grand Prix', 'hamilton', 'first place'),
     ('Singapore Grand Prix', 'hamilton', 'second place'),
     ('Singapore Grand Prix', 'massa', 'third place'),
     ('Singapore Grand Prix', 'kubica', 'first place'),
     ('Brazilian Grand Prix', 'hamilton', 'second place'),
     ('Brazilian Grand Prix', 'massa', 'third place'),
